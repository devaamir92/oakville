...
interface FemaleWithChildProps {
  className?: string;
}

const FemaleWithChild: React.FC<FemaleWithChildProps> = ({ className }) => {
  return (
    <Base className={className}>
      <g>
        <g>
          <ellipse
            transform="matrix(0.7071 -0.7071 0.7071 0.7071 -0.093 116.5992)"
            cx="140.7"
            cy="58.41"
            rx="58.41"
            ry="58.41"
          />
          <path
            d="M280.45,296.89l-30.04-101.98c-4.71-16.89-11.45-31.2-22.89-41.83c-12.1-11.25-28.31-18.08-46.01-18.08h-74.07
        ...
        <g>
          <ellipse
            transform="matrix(0.9871 -0.1602 0.1602 0.9871 -45.0621 62.8505)"
            cx="367.3"
            cy="310.93"
            rx="48.31"
            ry="48.31"
          />
          <path
            d="M461.93,462.55l-0.26-2.39c-3.04-28.52-5.45-51.05-20.02-67.42c-15-16.84-39.5-23.36-81.9-21.79
...
export default FemaleWithChild;
