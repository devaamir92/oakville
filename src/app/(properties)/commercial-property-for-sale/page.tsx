...
export const metadata: Metadata = {
  title: 'Commercial Property For Sale in Oakville The Preserve',
  description:
    'Explore commercial property for sale in Preserve Oakville, luxury properties for every lifestyle. Find your best property desirable in Oakville the preserve.',
};
          ...
          >
            ...
            >
              <Property
                ...
                title="Commercial Property for Sale in Rural Oakville & Uptown Core"
                S_r="Sale"
                location="/commercial-property-for-sale"
                classType="CommercialProperty"
              />
            </Suspense>
          </section>
