...
export const metadata: Metadata = {
  title: 'Townhouses For Sale in Preserve Oakville | Homes For Sale',
  description:
    'Explore Townhouses for sale in Preserve Oakville, stylish properties for various lifestyles. Find your dream homes in this desirable Oakville community.',
};
          ...
          >
            ...
            >
              <Property
                ...
                title="Townhouses for Sale in Rural Oakville & Uptown Core"
                S_r="Sale"
                location="/townhouses-for-sale"
              />
            </Suspense>
          </section>
        </div>
