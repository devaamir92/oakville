...
export const metadata: Metadata = {
  title: 'Sold Condo Townhouses in Preserve Oakville |Find Sold Homes',
  description:
    'Explore recently sold condo Townhouses, land and more at Oakville The Preserve. Find sold homes from the most comprehensive source of real estate data online.',
};
          ...
          >
            ...
            >
              <Property
                ...
                bathrooms={searchParams?.bathrooms}
                basement={searchParams?.basement}
                title="Sold Condo Townhouses in Preserve Oakville"
                location="/sold-condo-townhouses"
                Status="U"
                Lsc="Sld"
                sort="Cd"
                days={Number(searchParams?.days ?? 0)}
