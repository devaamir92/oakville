...
export const metadata: Metadata = {
  title: 'Condos For Sale in Preserve Oakville| Best Homes in Oakville',
  description:
    'Explore condos for sale in Preserve Oakville, featuring luxury properties for every lifestyle. Find your dream homes in this desirable Canadian neighborhood.',
};
