...
export const metadata: Metadata = {
  title: 'Condo Townhouses For Sale in Preserve Oakville | Best Homes',
  description:
    'Explore Condo Townhouses for sale in Preserve Oakville, luxury properties for every lifestyle. Find your dream homes in this desirable Canadian neighborhood',
};
